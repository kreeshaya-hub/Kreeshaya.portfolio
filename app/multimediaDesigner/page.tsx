    ...
    return (
        <Card>
            <div className="flex flex-col items-center w-screen min-h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
                <Navigation key="multimedia" currentPage="multimediaDesigner" />

                <motion.div
                    className={`fixed top-20 left-0 right-0 flex justify-center z-50 ${showContent ? "pointer-events-none" : ""
                        }`}
